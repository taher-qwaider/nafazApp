...
@section('page-name','تعديل خدمات')
@section('main-page','الرئيسية')
@section('sub-page','تعديل خدمات')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">تعديل خدمات</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="create_slider" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="body" value="{{ $service->body }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="button" onclick="performUpdate({{ $service->id }})" class="btn btn-primary">حفظ</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
...
@section('scripts')
    ...
    <script>
        function performUpdate(id) {
            ...
            axios.post('/panel/cms/services/'+id+'/update', formData
            )
