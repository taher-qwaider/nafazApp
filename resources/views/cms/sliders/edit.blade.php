                        ...
                        <form role="form" id="create_slider" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sub_title" name="title" value="{{ $slider->sub_title }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="link" name="title" value="{{ $slider->link }}">
                                </div>
                            </div>
                            <!-- /.card-body -->
                            <div class="card-footer">
                                <button type="button" onclick="performUpdate({{ $slider->id }})" class="btn btn-primary">حفظ</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
...
@section('scripts')
    ...
    <script>
        function performUpdate(id) {
            ...
            axios.post('/panel/cms/slider/'+id+'/update', formData
            )
