...
@section('title','تعديل الشعار')
@section('page-name','تعديل الشعار')
@section('main-page','الرئيسية')
@section('sub-page','تعديل الشعار')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">تعديل الشعار</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="create_slider" method="POST">
                            ...
                            <div class="card-footer">
                                <button type="button" onclick="performUpdate()" class="btn btn-primary">حفظ</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
