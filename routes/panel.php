...
Route::prefix('')->middleware('guest:user')->group(function(){
    ...
    Route::get('cms/login', [\App\Http\Controllers\auth\AuthController::class, 'getLoginView']);
    Route::post('cms/login', [\App\Http\Controllers\auth\AuthController::class, 'login']);
});
